...
//
//var (
//	operationHandler map[OperationID]func(interface{}, *YadosServer) (*Response, error)
//)
//
//func handleMessage(op Request, server *YadosServer) (*Response, error) {
...
//	operationHandler = make(map[OperationID]func(interface{}, *YadosServer) (*Response, error))
//
...
//func SetupRouter(server *YadosServer) *gin.Engine {
//	initialize()
//
